...
public class Performance extends Booking {
    private final TypeID type = TypeID.PERFORMANCE;

    public Performance(int bookID, Contact contact, String title, String description, Timestamp startTime, Timestamp endTime, Timestamp updated) {
