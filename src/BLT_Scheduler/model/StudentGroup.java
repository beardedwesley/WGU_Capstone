...
public class StudentGroup extends Booking {
    private final TypeID type = TypeID.STUDENT_GROUP;

    public StudentGroup(int bookID, Contact contact, String title, String description, Timestamp startTime, Timestamp endTime, Timestamp updated) {
