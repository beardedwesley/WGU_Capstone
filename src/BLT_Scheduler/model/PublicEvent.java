...
public class PublicEvent extends Booking{
    private final TypeID type = TypeID.PUBLIC_EVENT;

    public PublicEvent(int bookID, Contact contact, String title, String description, Timestamp startTime, Timestamp endTime, Timestamp updated) {
